...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_delete_other_users_recipe_errors(self):
        """Test Trying to delete another users errors recipe gives error."""
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_reate_recipe_with_new_ingredients(self):
    ...
    def test_update_recipe_assing_ingredients(self):
        ...
        ingredient1 = Ingredient.objects.create(user=self.user, name='Prepper')
        recipe = create_recipe(user=self.user)
